...
namespace RedLine.View
{
	...
	public class RedLineRibbon : Office.IRibbonExtensibility, IPartImportsSatisfiedNotification
	{
		...
		public event EventHandler BuildHistogram;
		private void RaiseBuildHistogram()
		{
			BuildHistogram?.Invoke(this, EventArgs.Empty);
		}
		...
		public void OnHistogramClicked(Office.IRibbonControl control)
		{
			RaiseBuildHistogram();
		}
